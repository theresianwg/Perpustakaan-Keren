                        ...
                        <ul>
                            <li
                                ...
                                <svg width="20" height="20" fill="currentColor"
                                    class="mx-4 text-gray-400  " viewBox="0 0 1024 1024">
                                    <path
                            ...
                            <li
                                class="flex items-center text-gray-400 justify-between py-3 border-b-2 border-gray-100  ">
                                <div class="flex items-center justify-start text-sm">
                                    <span class="mx-4">
                                        04
                                    </span>
                    ...
                    <div class="shadow-lg rounded-2xl bg-white  w-full">
                        ...
                        <div
                            ...
                            <p class="text-xs flex items-center  ">
                                <svg width="20" height="20" fill="currentColor" class="text-blue-500 mr-2"
                                    viewBox="0 0 24 24">
                                    <g fill="none">
                                        <path
                        ...
                        <div
                            class="py-2 px-4 text-gray-600 flex items-center justify-between border-b-2 border-gray-100">
                            <p class="text-xs flex items-center  ">
                                ...
                                <div class="-mx-2">
                                    <table class="w-full  ">
                                        ...
                                        <tr class="text-gray-400  ">
                                            <td
                                                class="py-3 px-2 md:px-3  text-center text-gray-300  ">
                                                25
                                            </td>
                                            <td
                                                class="py-3 px-2 md:px-3  text-center text-gray-300  ">
