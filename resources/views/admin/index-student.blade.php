<x-layouts.admin>
    <div class="">
        ...
        <div
            ...
            <h1 class="text-2xl font-bold">{{ __('admin.index.students.title') }}</h1>
            ...
            {{-- <div class="relative flex items-center w-full lg:w-64 h-full group">
                ...
                <input type="text"
                    ...
                    placeholder={{ __('admin.index.students.search') }} />
                    ...
                    <thead>
                        <tr>
                            <th scope="col"
                                ...
                                {{ __('admin.index.students.columns.1') }}
                            </th>
                            <th scope="col"
                                class="px-5 py-3 bg-white  border-b border-gray-200 text-gray-800  text-left text-sm uppercase font-bold">
                                {{ __('admin.index.students.columns.2') }}
                            </th>
                            <th scope="col"
                                class="px-5 py-3 bg-white  border-b border-gray-200 text-gray-800  text-left text-sm uppercase font-bold">
                                {{ __('admin.index.students.columns.3') }}
                            </th>
                            <th scope="col"
                                class="px-5 py-3 bg-white  border-b border-gray-200 text-gray-800  text-left text-sm uppercase font-bold">
                                {{ __('admin.index.students.columns.4') }}
                            </th>
                            <th scope="col"
                                class="px-5 py-3 bg-white  border-b border-gray-200 text-gray-800  text-left text-sm uppercase font-bold">
                                {{ __('admin.index.students.columns.5') }}
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                                    ...
                                    <div class="flex space-x-2 items-center">
                                        @if ($user->is_verified)
                                            ...
                                            <span
                                                ...
                                                {{ __('admin.index.students.status.1') }}
                                            </span>
                                        @else
                                            <form action="{{ route('student.approve', $user->id) }}" method="POST">
                                                @csrf
                                                {{-- ======== button approve ======== --}}
                                                <button type="submit"
                                                    ...
                                                    {{ __('admin.index.students.status.2') }}
                                                </button>
                                            </form>
                                            {{-- ======== button delete ======== --}}
                                            <button type="button"
                                                ...
                                                {{ __('admin.index.students.status.3') }}
                                            </button>
                                        @endif
                                    </div>
                                </td>
